...
if __name__ == '__main__':
    ...
    try:
        len_input_signal = int(sys.argv[2])
        number_input_signal = int(sys.argv[1])
    except IndexError:
        print('no any parameter inputted, setting default values')
        len_input_signal = 10
        number_input_signal = 10

    mtj = Mtj(a, b, c)
    ac_current_list = np.linspace(10, 100, 91)
    # ac_current_list = [10, 20, 30, 40, 50]
    le_list = []
